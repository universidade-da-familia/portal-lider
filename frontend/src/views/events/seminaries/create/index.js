...
export default function SeminaryCreate({ className }) {
  ...
  return (
    ...
    userData !== {} && (
      <>
        <ContentHeader>Criar Seminário</ContentHeader>
        <Card>
          <CardBody>
            {/* DADOS DA IGREJA */}
            <Formik
                ...
                <Form>
                  ...
                  <div className="form-body">
                    <h4 className="form-section">
                      <User size={20} color="#212529" /> Dados do seminário
                    </h4>
                    <Row>
                      <Col lg="4" md="6" sm="12">
                        <FormGroup>
                    ...
                    <Row>
                      ...
                      <Col lg="4" md="12" sm="12">
                        <FormGroup>
                          <Label for="default_event_id">Sememinário</Label>
                          <Field
                            type="select"
                            component="select"
                            id="default_event_id"
